...
export function NotFoundPage({ scope = "global", requestedPrefix }: NotFoundPageProps) {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("notFoundBreadcrumb") }]);
  }, [setBreadcrumbs, t]);
  ...
  const title = scope === "invalid_company_prefix" ? t("companyNotFound") : t("pageNotFound");
  const description =
    scope === "invalid_company_prefix"
      ? t("companyNotFoundPrefix", { prefix: normalizedPrefix ?? "unknown" })
      : t("routeNotExist");
