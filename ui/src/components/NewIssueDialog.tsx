...
export function NewIssueDialog() {
  ...
  const createIssueErrorMessage =
    createIssue.error instanceof Error ? createIssue.error.message : t("failedToCreateIssue");
        ...
        {currentProject && currentProjectSupportsExecutionWorkspace && (
          <div className="px-4 py-3 shrink-0 space-y-2">
            <div className="space-y-1.5">
              <div className="text-xs font-medium">{t("executionWorkspace")}</div>
          ...
          <div className="px-4 pb-2 shrink-0">
            ...
            {assigneeOptionsOpen && (
              <div className="mt-2 rounded-md border border-border p-3 bg-muted/20 space-y-3">
                ...
                <div className="space-y-1.5">
                  <div className="text-xs text-muted-foreground">{t("thinkingEffort")}</div>
                ...
                {assigneeAdapterType === "claude_local" && (
                  <div className="flex items-center justify-between rounded-md border border-border px-2 py-1.5">
                    <div className="text-xs text-muted-foreground">{t("enableChrome")}</div>
                    <button
                      data-slot="toggle"
                      className={cn(
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span className="inline-flex items-center justify-center gap-1.5">
                ...
                <span>{createIssue.isPending ? t("creating") : t("createIssue")}</span>
              </span>
            </Button>
          </div>
        </div>
