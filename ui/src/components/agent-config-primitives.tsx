  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("specifyPathManually")}</DialogTitle>
            <DialogDescription>
              {t("browserSecurityBlocks")}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 text-sm">
            <section className="space-y-1.5">
              <p className="font-medium">{t("macOSFinder")}</p>
            ...
            <section className="space-y-1.5">
              <p className="font-medium">{t("windowsFileExplorer")}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
            ...
            <section className="space-y-1.5">
              <p className="font-medium">{t("terminalFallback")}</p>
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
