  ...
  return (
    <div className="space-y-4">
      <div className="space-y-1">
        <PropertyRow label={t("statusLabel")}>
          {onUpdate ? (
            <PickerButton
              current={goal.status}
        ...
        <PropertyRow label={t("levelLabel")}>
          {onUpdate ? (
            <PickerButton
              current={goal.level}
              options={GOAL_LEVELS}
        ...
        <PropertyRow label={t("ownerLabel")}>
          {ownerAgent ? (
            <Link
            ...
            <span className="text-sm text-muted-foreground">{t("ownerNone")}</span>
          )}
        </PropertyRow>

        {goal.parentId && (
          <PropertyRow label={t("parentGoalLabel")}>
            <Link
      ...
      <div className="space-y-1">
        <PropertyRow label={t("createdLabel")}>
          <span className="text-sm">{formatDate(goal.createdAt)}</span>
        </PropertyRow>
        <PropertyRow label={t("updatedLabel")}>
