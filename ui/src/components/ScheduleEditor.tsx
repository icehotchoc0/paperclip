...
const PRESET_KEYS: { value: SchedulePreset; key: string }[] = [
  { value: "every_minute", key: "scheduleEveryMinute" },
  { value: "every_hour", key: "scheduleEveryHour" },
  { value: "every_day", key: "scheduleEveryDay" },
  { value: "weekdays", key: "scheduleWeekdays" },
  { value: "weekly", key: "scheduleWeekly" },
  { value: "monthly", key: "scheduleMonthly" },
  { value: "custom", key: "scheduleCustom" },
];
    ...
    <div className="space-y-3">
      <Select value={preset} onValueChange={(v) => handlePresetChange(v as SchedulePreset)}>
        <SelectTrigger className="w-full">
          <SelectValue placeholder={t("chooseFrequency")} />
        </SelectTrigger>
        <SelectContent>
          {PRESET_KEYS.map((p) => (
      ...
      {preset === "custom" ? (
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {preset === "every_hour" && (
            <>
              <span className="text-sm text-muted-foreground">{t("atMinute")}</span>
              <Select
                value={minute}
                onValueChange={(m) => {
                  setMinute(m);
          ...
          {preset === "weekly" && (
            <>
              <span className="text-sm text-muted-foreground">{t("onDay")}</span>
          ...
          {preset === "monthly" && (
            <>
              <span className="text-sm text-muted-foreground">{t("onDayOfMonth")}</span>
              <Select
                value={dayOfMonth}
                onValueChange={(dom) => {
                  setDayOfMonth(dom);
