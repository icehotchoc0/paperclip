...
export function OnboardingWizard() {
  ...
  async function runAdapterEnvironmentTest(
    ...
    if (!createdCompanyId) {
      setAdapterEnvError(
        t("onboarding.createOrSelectCompany")
      );
      return null;
    }
    ...
    try {
      ...
      setAdapterEnvError(
        err instanceof Error ? err.message : t("onboarding.adapterEnvTestFailed")
      );
      return null;
    } finally {
      setAdapterEnvLoading(false);
          ...
          >
            <div className="w-full max-w-md mx-auto my-auto px-8 py-12 shrink-0">
              ...
              <div className="flex items-center gap-0 mb-8 border-b border-border">
                {(
                  [
                    { step: 1 as Step, label: t("onboarding.companyTab"), icon: Building2 },
                    { step: 2 as Step, label: t("onboarding.agentTab"), icon: Bot },
                    { step: 3 as Step, label: t("onboarding.taskTab"), icon: ListTodo },
                    { step: 4 as Step, label: t("onboarding.launchTab"), icon: Rocket }
                  ] as const
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {t("onboarding.chooseAdapterDescription")}
                      </p>
                    </div>
                  </div>
                  <div>
